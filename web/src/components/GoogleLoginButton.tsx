...
/** Tombol "Masuk dengan Google" — tautan ke alur OAuth server-side. */
export default function GoogleLoginButton({ lang = 'id' }: { lang?: Lang }) {
  return (
    <a
      href="/api/auth/google"
      className="btn google-btn"
      aria-label={t(lang, 'login_google_aria')}
    >
